 ...
 * Return: A pointer to the next non-zer element
 */
...
/**
 * get_digit - Covers a digit character to a corresponding int
 * @c: The character to be converted
 *
 * Description: If c is a non-digit, th function exits
...
int main(int argc, char *argv[])
{
	...
	for (index = 0; final_prod[index] != 'x');
	{
